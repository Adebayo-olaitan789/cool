        ...
        <div className="section-header">
          ...
          <div className="course-filter-group">
            <ul className="lab-ul">
              ...
              <li onClick={() => filtterItem("Shoes")}>Shoes</li>
              <li onClick={() => filtterItem("Bags")}>Bags</li>
              <li onClick={() => filtterItem("Phones")}>Phones</li>
              <li onClick={() => filtterItem("Beauty")}>Beauty</li>
            </ul>
          </div>
        </div>
